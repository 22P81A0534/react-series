...
function App() {
  ...
  return (
    <div
      ...
      style={{
        backgroundImage: `url('https://www.zdnet.com/a/img/2022/10/12/bbd4f0b2-74c9-40ee-ad5a-5600101cf38a/google-pixel-7-and-7-pro.jpg')`,
      }}
    >
          ...
          >
            ...
            <div className="relative w-full h-0.5">
              <button
                ...
                border-white rounded-md bg-blue text-white px-2 py-0.5"
                onClick={swap}
              >
                swap
              </button>
